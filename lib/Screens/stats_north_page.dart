...
class StatsNorth extends StatefulWidget {
  final int profileNbr;

  const StatsNorth({Key? key, required this.profileNbr}) : super(key: key);

  @override
  _StatsNorthState createState() => _StatsNorthState();
}

class _StatsNorthState extends State<StatsNorth> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_north"]["adventures"]["adventure_1"]["completed"]) {
      unlocked_adventures ++ ;
    }

    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_north"]["adventures"]["adventure_2"]["completed"]) {
      unlocked_adventures ++ ;
    }
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          AnimatedGameButton("assets/icons/red_button_icon.png", screenWidth * 0.18, screenHeight * 0.18, screenWidth * 0.28, screenHeight * 0.17,"North"),
