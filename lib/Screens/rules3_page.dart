...
import 'package:project_2cp_eq11/Screens/rules4_page.dart';


class Rules3Page extends StatefulWidget {
  final int profileNbr;
  const Rules3Page({Key? key, required this.profileNbr}) : super(key: key);
  @override
  _Rules3PageState createState() => _Rules3PageState();
}

class _Rules3PageState extends State<Rules3Page> with SingleTickerProviderStateMixin {
  ...
  child: Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => Rules4Page(profileNbr: widget.profileNbr,)));
          },
          style: ElevatedButton.styleFrom(
            padding: EdgeInsets.symmetric(
              horizontal: MediaQuery.of(context).size.width * 0.07, 
