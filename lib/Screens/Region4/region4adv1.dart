                ...
                MaterialPageRoute(
                  builder:
                      (context) => ChooseItem(
                        ...
                        items: [
                          "assets/icons/region4/adventure1/tool1.png",
                          "assets/icons/region4/adventure1/tool2.png",
                          "assets/icons/region4/adventure1/tool3.png",
                          "assets/icons/region4/adventure1/tool4.png",
                        ],
                        imgHeight: 0.45,
                        imgWidth: 0.16,
                ...
                MaterialPageRoute(
                  builder:
                      (context) => ChooseItem(
                        ...
                        profileNb: widget.profileNbr,
                        items: [
                          "assets/icons/region4/adventure1/kit1.png",
                          "assets/icons/region4/adventure1/kit2.png",
                          "assets/icons/region4/adventure1/kit3.png",
                          "assets/icons/region4/adventure1/kit4.png",
                        ],
                        imgHeight: 0.45,
                        imgWidth: 0.16,
                ...
                MaterialPageRoute(
                  builder:
                      (context) => ChooseItem(
                        ...
                        profileNb: widget.profileNbr,
                        items: [
                          "assets/icons/region4/adventure1/item1.png",
                          "assets/icons/region4/adventure1/item2.png",
                          "assets/icons/region4/adventure1/item3.png",
                          "assets/icons/region4/adventure1/item4.png",
                        ],
                        imgHeight: 0.45,
                        imgWidth: 0.16,
                        text: "take a seat !!",
            ...
            dialogues: [
              {
                ...
                "bg": "assets/backgrounds/region4/adventure1/bg3.jpg",
                "text":"Stories without words? That’s so cool! Now let’s rest a bit before continuing the journey!! ",
                "speakerIcon1": "assets/icons/region1/adventure1/fennec.png",
                "speakerIcon2": "assets/icons/region4/adventure1/Maria.png",
                "textBoxIcon":"assets/icons/region1/adventure1/fennec_dialogue_box.png",
                "speaker": "fennec",
