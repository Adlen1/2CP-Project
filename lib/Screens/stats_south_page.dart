...
import 'package:project_2cp_eq11/Screens/stats_west_page.dart';
import 'package:provider/provider.dart';
import 'package:project_2cp_eq11/account_data/user_data_provider.dart';

class StatsSouth extends StatefulWidget {
  final int profileNbr;

  const StatsSouth({Key? key, required this.profileNbr}) : super(key: key);

  @override
  _StatsSouthState createState() => _StatsSouthState();
}

class _StatsSouthState extends State<StatsSouth> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_south"]["adventures"]["adventure_1"]["completed"]) {
      unlocked_adventures ++ ;
    }

    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_south"]["adventures"]["adventure_2"]["completed"]) {
      unlocked_adventures ++ ;
    }
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          AnimatedGameButton("assets/icons/light_red_button_icon.png", screenWidth * 0.18, screenHeight * 0.18, screenWidth * 0.59 , screenHeight * 0.17,"West" ,destination: StatsWest(profileNbr:widget.profileNbr),),
          ...
          AnimatedGameButton("assets/icons/red_button_icon.png", screenWidth * 0.18, screenHeight * 0.18, screenWidth * 0.745, screenHeight * 0.17,"South"),
