...
class StatsEast extends StatefulWidget {
  final int profileNbr;

  const StatsEast({Key? key, required this.profileNbr}) : super(key: key);

  @override
  _StatsEastState createState() => _StatsEastState();
}

class _StatsEastState extends State<StatsEast> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_east"]["adventures"]["adventure_1"]["completed"]) {
      unlocked_adventures ++ ;
    }

    if(userData['Profiles']['Profile_${widget.profileNbr}']['Regions']["region_east"]["adventures"]["adventure_2"]["completed"]) {
      unlocked_adventures ++ ;
    }
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          AnimatedGameButton("assets/icons/red_button_icon.png", screenWidth * 0.18, screenHeight * 0.18, screenWidth * 0.435, screenHeight * 0.17," East"),
