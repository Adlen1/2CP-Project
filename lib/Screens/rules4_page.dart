...
class Rules4Page extends StatefulWidget {
  final int profileNbr;
  const Rules4Page({Key? key, required this.profileNbr}) : super(key: key);
  @override
  _Rules4PageState createState() => _Rules4PageState();
}

class _Rules4PageState extends State<Rules4Page> with SingleTickerProviderStateMixin {
