...
import 'package:project_2cp_eq11/Screens/rules2_page.dart';


class Rules1Page extends StatefulWidget {
  final int profileNbr;
  const Rules1Page({Key? key, required this.profileNbr}) : super(key: key);

  @override
  _Rules1PageState createState() => _Rules1PageState();
}

class _Rules1PageState extends State<Rules1Page> with SingleTickerProviderStateMixin {
    ...
    child: Row(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => Rules2Page(profileNbr: widget.profileNbr,)));
