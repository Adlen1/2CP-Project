...
import 'package:project_2cp_eq11/Screens/Region4/region4adv1.dart';
import 'package:project_2cp_eq11/Screens/Region4/region4adv2.dart';
        ...
        children: [
          ...
          ...regionButtons[currentRegion]!.asMap().entries.map((entry) {
            ...
            if (!isUnlocked) {
              ...
              iconPath = "assets/icons/regions_page/${index}completed.png";
            } else {
