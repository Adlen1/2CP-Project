          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center, // Center align images
                  children: List.generate(widget.items.length, (index) {
                    return Padding(
                      padding: EdgeInsets.only(right: screenWidth * 0.042,), // Reduce space between images
                      child: Column(
                        children: [
                          // Image with Border
                          Container(
                          ...
                          SizedBox(height: screenHeight * 0.02), // Reduce vertical space
