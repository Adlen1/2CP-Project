...
/// ============================================================================
///
/// this page lets the user reEnter his personal info
///
///
  ...
  void initState() {
    ...
    setState(() {
      _firstNameController.text =
          userData['Profiles']['Profile_${widget.profileNbr}']['firstName'];
      _lastNameController.text =
          userData['Profiles']['Profile_${widget.profileNbr}']['lastName'];
      _ageController.text =
          userData['Profiles']['Profile_${widget.profileNbr}']['age'];
      selectedIndex = int.parse(
        userData['Profiles']['Profile_${widget.profileNbr}']['avatar'],
      );
    });
  }
                ...
                child: Material(
                  ...
                  child: InkWell(
                    ...
                    onTap: () {
                      ...
                      userData['Profiles']['Profile_${widget.profileNbr}']['created'] =
                          true;
                      userData['Profiles']['Profile_${widget.profileNbr}']['firstName'] =
                          firstName;
                      userData['Profiles']['Profile_${widget.profileNbr}']['lastName'] =
